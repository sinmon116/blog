				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="355px" class="tdColor">留言者</td>
							<td width="260px" class="tdColor">留言内容</td>
							<td width="275px" class="tdColor">留言时间</td>
						...
						<tr>
							...
							<td><?=$value['neirong']; ?></td>
							<td><?=$time = date('Y-m-d H:i:s' , $value['lctime']); ?></td>
							<td><a href="/index.php?m=Admin&a=delly&lid=<?=$value['lid']; ?>">
									
								<img src="/public/admin/img/delete.png"></a></td>
						</tr>
						<?php endforeach; ?>
						<?php endif; ?>
					</table>
