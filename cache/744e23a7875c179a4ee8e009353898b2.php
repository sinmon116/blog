...
<body>
	<div id="pageAll">
		...
		<form action="/index.php?m=Admin&a=change" method='post'>
		<div class="page ">
			<!-- 修改密码页面样式 -->
			<div class="bacen">
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;管理员UID：&nbsp;&nbsp;&nbsp;&nbsp;<?=$_SESSION['uid']; ?></div>
				<div class="bbD">管理员用户名：&nbsp;&nbsp;&nbsp;&nbsp;<?=$_SESSION['username']; ?></div>
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入新密码：<input type="password" class="input3"
						onblur="checkpwd2()" id="pwd2" name='password'/> <img class="imga"
