...
.cke_toolbox_collapser.cke_toolbox_collapser_min{
    ...
    <div class="atl-add-bg pb-mt40"> 
     <div class="atl-add-head pb-main"> 
      <h3>板凳要坐十年冷，文章不写一句空</h3> 
      <p>· 君子有三乐，而王天下不与存焉。父母俱在，兄弟无故，一乐也；仰不愧于天，俯不怍于人，二乐也；得天下英才而教育之，三乐也。</p> 
	  <p>·不怀疑不能见真理，所以我期望大家都取怀疑态度，不要为已成的学说所压倒。</p>
	  <p>·我永远相信只要永不放下，我们还是有机会的。最后，我们还是坚信一点，这世界上只要有梦想，只要不断努力，只要不断学习，不管你长得如何，不管是这样，还是那样，男人的长相往往和他的的才华成反比。这天很残酷，明天更残酷，后天很完美，但绝对大部分是死在明天晚上，所以每个人不要放下这天。</p>
	</div> 
    </div> 
    <div class="pb-main atl-add pb-mt30"> 
     <div class="pb-inner-main"> 
	 <!-- 表单处理 -->
      <form  action="/index.php?m=Life&a=dopost" method="post" enctype="multipart/form-data"> 
       <h3 class="pb-size-big pb-clr1"><a class="pb-clr2" href="javascript:Sys.showRuleDiv();"></a>标题</h3> 
       <p class="tle pb-mt10"> <input class="text-input small-input" name="title" type="text" maxlength="18" /> </p> 
       <h3 class="pb-mt5 pb-size-big pb-clr1">内容</h3>
       <div class="editormd" id="test-editormd">
<textarea placeholder="長得好看的都會在這邊說點什麼O(∩_∩)O~~..." name="content" class="commentbody" rows="5" style="border:1px solid #edf1f6;background:#fff;width:670px;height:500px;" tabindex="4"></textarea>
		</div>
      <h3 class="pb-mt10 pb-size-big pb-clr1">封面</h3> <br /> 
	  <input type='file' name='file'>
       <p class="but pb-mt50"> <input type="submit" onclick="submitPostForm();" value="投稿" name="submit" class="pb-button01" /> 
